...
NAME("RDB$CONSTANTS", nam_constants)
...
NAME("MON$TABLE_ID", nam_mon_tab_id)
NAME("MON$LOCAL_TEMPORARY_TABLE_COLUMNS", nam_mon_local_temp_table_columns)
NAME("MON$FIELD_NAME", nam_mon_f_name)
NAME("MON$FIELD_POSITION", nam_mon_f_position)
NAME("MON$FIELD_TYPE", nam_mon_f_type)
NAME("MON$NOT_NULL", nam_mon_null_flag)
NAME("MON$FIELD_LENGTH", nam_mon_f_length)
NAME("MON$FIELD_SCALE", nam_mon_f_scale)
NAME("MON$FIELD_PRECISION", nam_mon_f_precision)
